<template>
  <div>
    <!-- HOME HERO -->
  <div class="relative h-screen w-100 bg-no-repeat bg-cover bg-bottom bg-[url('https://carconfigurator.ferrari.com/assets/cars/purosangue/packages/default/splashpage.jpg')]">
